...
#ifndef _VSERVANT_SIM_SERVICE__M0_MB2000_S1_W1_C0_A0_H_
#define _VSERVANT_SIM_SERVICE__M0_MB2000_S1_W1_C0_A0_H_  // guard
...
VL_MODULE(Vservant_sim_service__M0_MB2000_S1_W1_C0_A0) {
  public:
    // CELLS
    ...
    struct {
        ...
        CData/*2:0*/ __PVT__rx_from_ble__DOT__data_index;
    ...
    CData/*2:0*/ __Vdly__rx_from_ble__DOT__data_index;
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vservant_sim_service__M0_MB2000_S1_W1_C0_A0);  ///< Copying not allowed
  public:
    Vservant_sim_service__M0_MB2000_S1_W1_C0_A0(const char* name = "TOP");
    ~Vservant_sim_service__M0_MB2000_S1_W1_C0_A0();
