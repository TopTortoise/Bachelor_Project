    ...
    , TOP__servant_sim__dut__ram(Verilated::catName(topp->name(), "servant_sim.dut.ram"))
{
    ...
    // Setup scopes
    __Vscope_servant_sim__dut__ram.configure(this, name(), "servant_sim.dut.ram", "ram", -12, VerilatedScope::SCOPE_OTHER);
    // Setup export functions
    for (int __Vfinal=0; __Vfinal<2; __Vfinal++) {
        __Vscope_servant_sim__dut__ram.varInsert(__Vfinal,"mem", &(TOP__servant_sim__dut__ram.mem), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,2 ,31,0 ,2047,0);
    }
}
