...
void Vservant_sim::_settle__TOP__2(Vservant_sim__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->o_data = vlSymsp->TOP__servant_sim__dut.__PVT__o_data;
    vlTOPp->to_pc = vlSymsp->TOP__servant_sim__dut.__PVT__to_pc;
}
...
void Vservant_sim::_eval_initial(Vservant_sim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__servant_sim__dut__ram._initial__TOP__servant_sim__dut__ram__1(vlSymsp);
...
void Vservant_sim::_eval_settle(Vservant_sim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__servant_sim__dut__ram._sequent__TOP__servant_sim__dut__ram__3(vlSymsp);
}
