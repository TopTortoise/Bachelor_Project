...
VL_CTOR_IMP(Vservant_sim_service__pi1) {
    VL_CELL(ram, Vservant_sim_servant_ram__pi3);
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vservant_sim_service__pi1::__Vconfigure(Vservant_sim__Syms* vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
    if (false && this->__VlSymsp) {}  // Prevent unused
}

Vservant_sim_service__pi1::~Vservant_sim_service__pi1() {
}

void Vservant_sim_service__pi1::_initial__TOP__servant_sim__dut__1(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_service__pi1::_initial__TOP__servant_sim__dut__1\n"); );
...
void Vservant_sim_service__pi1::_settle__TOP__servant_sim__dut__4(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_service__pi1::_settle__TOP__servant_sim__dut__4\n"); );
    Vservant_sim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vservant_sim_service__pi1::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vservant_sim_service__pi1::_ctor_var_reset\n"); );
    // Body
    ...
    __PVT__rx_from_ble__DOT__data_index = VL_RAND_RESET_I(4);
    ...
    __Vdly__rx_from_ble__DOT__data_index = VL_RAND_RESET_I(4);
